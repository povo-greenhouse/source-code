...
#define Y_AXIS_PORT  GPIO_PORT_P6
#define Y_AXIS_PIN  GPIO_PIN0
#define Y_AXIS_MEM ADC_MEM0
#define Y_AXIS_INPUT ADC_INPUT_A15

#define X_AXIS_PORT GPIO_PORT_P4
#define X_AXIS_PIN GPIO_PORT_P4
#define X_AXIS_MEM ADC_MEM1
#define X_AXIS_INPUT ADC_INPUT_A9
