...
void adc_init(){
    //first configure the pins
        ...
        ADC14_configureConversionMemory(TANK_SENSOR_MEM,ADC_VREFPOS_AVCC_VREFNEG_VSS, TANK_SENSOR_INPUT,ADC_DIFFERENTIAL_INPUTS);

        ADC14_configureConversionMemory(RESERVOIRE_SENSOR_MEM,ADC_VREFPOS_AVCC_VREFNEG_VSS,RESERVOIRE_SENSOR_INPUT,ADC_DIFFERENTIAL_INPUTS);
